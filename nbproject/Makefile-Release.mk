...
${OBJECTDIR}/BrokerHandler.o: BrokerHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BrokerHandler.o BrokerHandler.cpp

${OBJECTDIR}/ClientStorage.o: ClientStorage.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientStorage.o ClientStorage.cpp

${OBJECTDIR}/ClientTestSuite.o: ClientTestSuite.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientTestSuite.o ClientTestSuite.cpp
